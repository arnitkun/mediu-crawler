...
//   'http://www.medium.com/the-hairpin?source=---------5------------------&9db0094a1e0f?source=post_page-----969aa274da55----------------------': true,
...
// //   let params = getAllUrlParams(link);
//   let params = [];
//   let list =  Object.keys(arr).forEach(link => {
//       params.push( getAllUrlParams(link));
//   });
